# Klastering Daerah Berpotensi Maju Berdasarkan Indeks Pembangunan Manusia di Indonesia Menggunakan Metode K-Means
...
- [Dataset](https://www.bps.go.id/id): Dataset yang digunakan dalam proyek.
